...
sequenceDiagram
    ...
    Note right of browser: The browser executes spa.js, fetching the JSON data
    ...
    Note right of browser: The browser renders notes dynamically without page reloads
```
